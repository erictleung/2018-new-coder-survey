...
With the proportion of `NA` values in each row, let us visualize this to get a
better feel of the level of sparsity we're dealing with.

```{r}
# Plot distribution of completeness of rows
```
